...
def prueba():
    ...
    imagen2 = cv2.resize(gray, None, fx=0.05, fy=0.07, interpolation = cv2.INTER_CUBIC)
    ...
    warped = four_point_transform(imagen2, displayCnt.shape(4, 2))
    output = four_point_transform(imagen2, displayCnt.shape(4, 2))
